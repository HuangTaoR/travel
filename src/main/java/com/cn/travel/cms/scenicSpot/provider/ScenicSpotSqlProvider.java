...
public class ScenicSpotSqlProvider {
    ...
    public String count() {
        return "SELECT count(*) FROM t_cms_scenic_spot WHERE DELETE_STATUS=0";
    }

    public String count2() {
        return "SELECT count(*) FROM t_cms_scenic_spot WHERE DELETE_STATUS=0 AND STATE=1";
    }
    ...
    public String state0count() {
        return "SELECT count(*) FROM t_cms_scenic_spot WHERE DELETE_STATUS=0 AND STATE=0";
    }
    ...
    public String state2count() {
        return "SELECT count(*) FROM t_cms_scenic_spot WHERE DELETE_STATUS=0 AND STATE=2";
    }
}
