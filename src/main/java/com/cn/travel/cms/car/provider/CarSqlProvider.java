...
public class CarSqlProvider {
    ...
    public String count() {
        return "SELECT count(*) FROM t_cms_car WHERE DELETE_STATUS=0";
    }
    ...
    public String state0count() {
        return "SELECT count(*) FROM t_cms_car WHERE DELETE_STATUS=0 AND STATE=0";
    }

    public String state1count() {
        return "SELECT count(*) FROM t_cms_car WHERE DELETE_STATUS=0 AND STATE=1";
    }

    public String state2count() {
        return "SELECT count(*) FROM t_cms_car WHERE DELETE_STATUS=0 AND STATE=2";
    }

    public String type0count() {
        return "SELECT count(*) FROM t_cms_car WHERE DELETE_STATUS=0 AND TYPE=0";
    }

    public String type1count() {
        return "SELECT count(*) FROM t_cms_car WHERE DELETE_STATUS=0 AND TYPE=1";
    }

    public String type2count() {
        return "SELECT count(*) FROM t_cms_car WHERE DELETE_STATUS=0 AND TYPE=2";
    }
