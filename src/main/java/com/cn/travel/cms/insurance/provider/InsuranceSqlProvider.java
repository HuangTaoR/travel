...
public class InsuranceSqlProvider {
    public String count() {
        return "SELECT count(*) FROM t_cms_insurance WHERE DELETE_STATUS=0 ";
    }
    ...
    public String state0count() {
        return "SELECT count(*) FROM t_cms_insurance WHERE DELETE_STATUS=0 AND STATE=0";
    }

    public String state1count() {
        return "SELECT count(*) FROM t_cms_insurance WHERE DELETE_STATUS=0 AND STATE=1";
    }

    public String state2count() {
        return "SELECT count(*) FROM t_cms_insurance WHERE DELETE_STATUS=0 AND STATE=2";
    }

    public String company0count() {
        return "SELECT count(*) FROM t_cms_insurance WHERE DELETE_STATUS=0 AND INSURANCE_COMPANY=0";
    }

    public String company1count() {
        return "SELECT count(*) FROM t_cms_insurance WHERE DELETE_STATUS=0 AND INSURANCE_COMPANY=1";
    }
}
